...
Extract data for winter (Jun - August) 2015 as per original EECA file. Aggregate to region level and select the top 100 half hours for eachh region.

```{r extractWinter2015Data}
gxpWinter2015DT <- gxpDataDT[lubridate::year(rDate) == 2015 & 
