...
As an example, Table \@ref(tab:ggHeatSource) shows the 'main method of heating' for the GREEN Grid sample and Figure \@ref(fig:ggHeatSource) compares these with the results from the BRANZ Housing Conditions Survey 2015 [@vicki_white_warm_2017]. As we can see the GREEn Grid sample has a higher heat pump rate than the HCS 2015 estimate of 40% (+/-6.1%) heat pump penetration for owner occupied homes (the most similar to the GREEN Grid sample) and 25% (+/-10.8%) for rentals. On the other hand, 25% of the GREEN Grid sample used enclosed woodburners as a main method of heating compared to HCS 2015 estimates of 39% and 23% for owener-occupied and rental dwellings respectively.
