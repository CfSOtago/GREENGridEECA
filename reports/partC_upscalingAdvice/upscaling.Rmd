...
kableExtra::kable(t, caption = "Summary of household level IPF weights", digits = 2) %>%
  kable_styling()

sum(ipfNationalWDT$ipfWeight)
```
...
```{r ipfTotalLoadRegional}
# sum the IPF weights per household at regional level
setkey(ipfRegionalWDT, linkID)
setkey(profileDT, linkID)
weightedProfileRegionalDT <- profileDT[ipfRegionalWDT, allow.cartesian = TRUE]
