...
# test table
t <- powerDT[year == 2015 & eecaCircuit == "Total", .(sumkWh = sum(meanEnergyWh/1000, na.rm = TRUE),
                             meankWh = mean(meanEnergyWh/1000, na.rm = TRUE),
                             mediankWh = median(meanEnergyWh/1000, na.rm = TRUE), 
...
```{r tableUpdate}
t2 <- powerDT[year == 2015 & eecaCircuit == "Total", .(sumkWh = sum(meanEnergyWh/1000, na.rm = TRUE), # add up the total kWh
...
plotDT <- powerDT[year == 2015 & eecaCircuit == "Total", .(sumkWh = sum(meanEnergyWh/1000, na.rm = TRUE),
                             meankW = mean(meanPowerW/1000, na.rm = TRUE),
                             sdkW = sd(meanPowerW/1000, na.rm = TRUE),
                 nDays = uniqueN(date),
