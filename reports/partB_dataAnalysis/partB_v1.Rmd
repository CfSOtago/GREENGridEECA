...
As background, Table \@ref(tab:dataDesc) shows the mean halfhourly and mean total kW and kWh by season for the sample households in 2015. For this purpose the periods are defined as:
