...
The sample coincident peak utilises the GREENGrid sample to define peak demand. This is in contrast to the previous section where peak demand was predefined as the time between 17:00 and 21:00 in winter. 
...
```
The following half hours were identified as the top 20 sample peak half hours in 2015:
```{r topPeak, echo=TRUE}
...
Table \@ref(tab:winterPeaktestTableSample) shows extracted data for the identified top 20 peak half hours for each dwelling and circuit. Furthermore, Table \@ref(tab:winterPeaktestTableSample) presnets the relative contribution to peak demand by dwelling and circuit.
...
Figure \@ref(fig:wattageContributionPeakSamplePlot) presents the wattage contribution on the 2015-06-28 at 18:00:00 as an average over the households for one of the identified top peak half hours. The results show that hot water contributes the most, followed by heat pumps and lighting. The plot also visualises that much power was drawn from circuits other than the identified ones (summarised in "Others").
