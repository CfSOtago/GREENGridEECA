...
Table \@ref(tab:extractHalfHourOven) and Figure \@ref(fig:extractHalfHourOven) show the mean power (mean of the half-hourly mean values)
for all observations extracted by circuit label. Note that in some cases circuits may contain other appliances. Analysis should therefore proceed with caution.
...
Table \@ref(tab:extractHalfHourPV) and Figure \@ref(fig:extractHalfHourPV) show the mean power (mean of the half-hourly mean values)
for all observations extracted by circuit label. Note that in some cases circuits may contain other appliances. Analysis should therefore proceed with caution.
